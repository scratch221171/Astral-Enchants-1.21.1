...
public class AEEnglishLangProvider extends AELangProvider {
    ...
    protected void addTranslations() {
        ...
        addEnchantWithDesc(
                ...
                "Mitigation Piercing",
                "Attacks penetrate various forms of damage mitigation.");
        ...
        addEnchantWithDesc(
                ...
                "Item Protection",
                "Disables the enchantment-disabling effect of the “Dispell” trait and the sealing effect of the “Ragnarok” trait added by L2Hostility.");
        addEnchantWithDesc(
        ...
        addEnchantWithDesc(
                AEEnchantments.COOLDOWN_REDUCTION, "Cooldown Reduction", "Reduces the cooldown of all items.");
        addEnchantWithDesc(
                AEEnchantments.FEATHER_TOUCH,
                "Feather Touch",
                "All breakable blocks are collected as items. While sneaking, block states and components are preserved.");
        addEnchantWithDesc(
                AEEnchantments.ADVENTURERS_LORE,
                "Adventurer's Lore",
                "Increases luck and the amount of experience gained from mobs and blocks based on the number of completed advancements.");
        addEnchantWithDesc(
                AEEnchantments.COMPATIBILITY,
                "Compatibility",
                "Allows additional enchantments to be applied to internal items of a bundle with this enchantment while ignoring conflicts.");
        addEnchantWithDesc(
                AEEnchantments.ENDLESS_APPETITE,
                "Endless Appetite",
                "Enhances natural regeneration and directly heals based on the amount of excess hunger and hidden saturation beyond their caps.");
        addEnchantWithDesc(
                AEEnchantments.MOMENTUM, "Momentum", "Negates movement speed reductions caused by item use or blocks.");
        addEnchantWithDesc(
                AEEnchantments.INSTANT_TELEPORT,
                "Instant Teleport",
                "When using an Ender Pearl, teleports you to the point you are looking at. While sneaking, the teleport ray passes through a block and sends you to the opposite side of it.");
        add(
                AEEnchantments.INSTANT_TELEPORT.location().toLanguageKey("enchantment", "message.fail"),
                "No valid block exists within range!");
        addEnchantWithDesc(
                AEEnchantments.OVERLOAD,
                "Overload",
                "Grants Overload to the item, increasing the level of existing enchantments by the Overload value.");
        ...
        addEnchantWithDesc(
                ...
                "Slot Expansion",
                "Increases the number of accessory slots the item currently occupies by the enchantment level.");
        addEnchantWithDesc(
        ...
        addEnchantWithDesc(
                ...
                "Mystic Remnants",
                "Killed mobs will occasionally drop enchanted books.");
        addEnchantWithDesc(
        ...
        addEnchantWithDesc(
                ...
                "Prevents enchantments on the item from being modified.");
        ...
        addEnchantWithDesc(
                ...
                "Over Mending",
                "By consuming a large amount of experience points and being struck by lightning, the tool will become indestructible.");
        add(AEEnchantments.OVER_MENDING.location().toLanguageKey("enchantment", "tooltip.text"), "Over Mending：%s %%");
        add(
        ...
        add(
                AstralEnchant.MOD_ID + ".configuration.section.astralenchant.server.toml.title",
                "Astral Enchant Server Config");

        add(AstralEnchant.MOD_ID + ".configuration.settings", "Enchantment Settings");
        addConfigWithDesc(
                AEConfig.LAST_STAND_REQUIRED_BASE_EXPERIENCE,
                "Required experience points for Last Stand (base value)",
                "The experience cost of Last Stand at level N is \"base value ÷ N\". By default, this is approximately 34 levels.");
        addConfigWithDesc(
                AEConfig.LAST_STAND_IGNORE_BYPASSES_INVULNERABILITY_TAG,
                "Last Stand ignores bypass-invulnerability",
                "When disabled, Last Stand will not activate against damage that has the BYPASSES_INVULNERABILITY tag (such as /kill or void damage).");
        addConfigWithDesc(
                AEConfig.ESSENCE_OF_ENCHANT_INCLUDE_OVERLOAD_IN_CALCULATION,
                "Include Overload levels in Essence of Enchant total level calculation",
                "Regardless of this setting, Overload levels are always applied to the level of Essence of Enchant itself.");
        addConfigWithDesc(
                AEConfig.ESSENCE_OF_ENCHANT_LEVEL_MULTIPLIER,
                "Essence of Enchant level multiplier (%)",
                "Specifies how many percent the modifier multiplier increases for each increase of 1 in the total enchantment level.");
        addConfigWithDesc(
                AEConfig.INSTANT_TELEPORT_DISTANCE_INCREASE_PER_LEVEL,
                "Instant Teleport distance increase per level",
                "Specifies how much the maximum teleportable distance increases for each level gained.");
        addConfigWithDesc(
                AEConfig.INSTANT_TELEPORT_MAX_DISTANCE,
        ...
        addConfigWithDesc(
                ...
                "Total experience points required for Over Mending",
                "By default, this is approximately 166 levels. It is recommended that you set it to a multiple of 100.");

        add(AstralEnchant.MOD_ID + ".configuration.misc", "Misc Settings");
        addConfigWithDesc(
                AEConfig.ENABLE_VANILLA_ITEM_RECIPES,
                "Enable vanilla item recipes",
